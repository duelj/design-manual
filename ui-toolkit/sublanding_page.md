...
<p>Sub-landing page types provide an overview of a topic and/or group of related content. As with the landing page type, the focus of these pages is enabling users to quickly skim content options and select the category that interests them or meets their need. The sub-landing page template should always be used as a child page to the Landing page template.</p>

<p>Each sub-landing page template has three basic content areas with two variations in layout:</p>

<nomarkdown>
<img src="{{site.baseurl}}/static/img/sublanding_examples.png" alt="landing examples" height="100%" width="100%">
</nomarkdown>
